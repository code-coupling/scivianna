...
class VisualizationPanel(pn.viewable.Viewer):
    ...
    def __init__(self, slave: ComputeSlave, name="", extensions: List[Extension] = []):
        ...
        self.axes_change_callback: Callable = None
        ...
        for extension in code_interface.extensions:
            ...
            if extension not in self.extension_classes:
        ...
        #
        self.extensions = [
            e(self.slave, self.plotter, self) for e in self.extension_classes
        ]
        ...
        self.button = pmui.IconButton(
            icon="settings_applications", icon_size="1em", margin=0
        )
    ...
    def provide_on_axes_change_callback(self, callback: Callable):
        ...
        the functions takes a three vectors as argument: u, v and location.
        ...
        callback : Callable
            Function to call.
        """
        self.axes_change_callback = callback
